...
class ZcmService(object):
    __slots__ = ["u_timestamp", "processing_time"]
    ...
    def _encode_one(self, buf):
        buf.write(struct.pack(">qi", self.u_timestamp, self.processing_time))
    ...
    def _decode_one(buf):
        self = ZcmService()
        self.u_timestamp, self.processing_time = struct.unpack(">qi", buf.read(12))
        return self
